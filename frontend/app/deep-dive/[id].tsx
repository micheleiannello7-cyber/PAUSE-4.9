    ...
    <Animated.View style={[styles.cover, box, { pointerEvents: "none" }]} testID="chapter-cover-bg">
      <Animated.View style={[styles.coverImage, { height: maxHeight }, breathe]}>
        {hasCover ? (
          ...
          <LessonCover color={story.category_color} icon={story.category_icon} categoryId={story.category_id} iconSize={72} showBadge={false} style={StyleSheet.absoluteFill} />
        )}
      </Animated.View>
